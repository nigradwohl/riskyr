...
## (1a) Function to create general riskyr scenarios based on a table: ------

#' Create general riskyr scenarios.
#'
#' The instantiation function \code{riskyr_tabular} is used to create
...
#'
#' @param x A matrix or dataframe of the specified form *e.g., see vignette???*
#'
#' @param x.lbls A matrix or dataframe of labels for the entries.
#'
...
riskyr_tabular <- function(x,
                           x.lbls = NULL,
                           scen.lbl = "",  ## WAS: txt$scen.lbl,
...
## (1b) Function to create general riskyr scenarios based on parameters: ------

#' Create general riskyr scenarios.
#'
#' The instantiation function \code{riskyr.general} is used to create
#' scenarios of class "riskyr",
#' which can then be visualized by the \code{plot} method \code{\link{plot.riskyr}}
#' and summarized by the \code{summary} method \code{\link{summary.riskyr}}.
#' More specific applications are derived from this function.
...
## (1c) Function to create diagnostic riskyr scenarios: ------
