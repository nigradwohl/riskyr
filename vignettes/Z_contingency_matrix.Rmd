...
* For frequencies one needs at least 2 occupied cells in both dimensions plus one additional non-redunddatn cell (e.g., hi+mi and dec.neg+N or hi+fa+cr+N).  However, information may not be redundant (if it is, more occupied cells are needed). 
...
* Probably, if you can generate one of the two above cases by a mixture, then it works out as well: e.g., PPV instead of hits and ppod instead of N.  It follows that 
